...
var VirtualRenderer = function(container, theme, do60fps) {
    ...
    this.$gutterLayer = new GutterLayer(container);//WebGLGutterLayer(webgl);
    this.$gutterLayer.on("changeGutterWidth", this.onResize.bind(this, true));
    this.setFadeFoldWidgets(false);

    this.$markerBack = new MarkerLayer(container);//MarkerLayerWebGL(webgl);

    this.$markerFront = new MarkerLayer(container);//MarkerLayerWebGL(webgl);
...
(function() {
    ...
    **/
    ...
    this.$draw = function() {
        ...
        */
        this.$font.vflip = this.layerConfig.upsidedown ? 1 : -1;
        this.$textLayer.draw();
    }
