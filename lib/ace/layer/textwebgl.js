...
var Text = function(parentEl) {
    ...
    this.$grid2d = webgl.create2dGrid(200, 100);
    this.$fontTexture = webgl.createFontTexture(256, 256, 'monospaced', 12);
    ...
    var fs = 
        ...
        "    gl_FragColor = texture2D(texture, pos / 10.0 + voffset);"+        
        "}";
    var vs = 
...
(function() {
    ...
    this.update = function(config) {
        ...
        this.$webgl.clear();
        this.$webgl.activateTextureForShader(this.$fontTexture, this.$fontShader);
        this.$webgl.drawPoints(this.$grid2d, this.$fontShader, 0, 0, 0);
